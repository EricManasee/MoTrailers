...
<html lang="en">
<head>
    <title>Code coverage report for imdb.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> imdb.ts
    </h1>
    <div class='clearfix'>
...
<a name='L641'></a><a href='#L641'>641</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        const prom = rp(reqopts).then((data: OmdbMovie | OmdbError) =&gt; {
            ...
            if (isError(data)) {
                throw new ImdbError(`${data.Error}: ${(req.name ? req.name : <span class="branch-1 cbranch-no" title="branch not covered" >req.id)</span>}`);
            }
&nbsp;
            if (isMovie(data)) {
                ret = new Movie(data);
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sun Aug 12 2018 23:54:10 GMT-0700 (PDT)
</div>
</div>
