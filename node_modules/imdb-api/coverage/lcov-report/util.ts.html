...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// A good case for generics, but javascript has strict
...
&nbsp;
    public get(key: string): string {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.obj[key] !== undefined) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sat May 12 2018 23:24:25 GMT-0700 (PDT)
</div>
</div>
